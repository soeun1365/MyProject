	...
	function searchId(){
		$('#serchId_btn').click(function(){
			if($('#email').val() == ''){
				...
				$('#f').attr('action', 'showIdByEmail.do');
				$('#f').submit();
			}
		});
	}
...
<div class="container">
	<div class="searchId_wrap">
		<div class="searchId">
			<a href="findIdByNamePhone.do">이름/전화번호로 찾기</a>
		</div>
		<div class="searchId">
			<b><a href="findIdByEmail.do">이메일로찾기</a></b>
		</div>
	</div>
	<div class="searchId_form">
		<form id="f" method="post">
			<div class="input">
				<input type="text" name="email" id="email" class="inp_tex" placeholder="이메일">			
			</div>
